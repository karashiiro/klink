        ...
        placeholder={`void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    fragColor = vec4(col,1.0);
      ...
      <YStack gap="$1">
        ...
        <Paragraph color="rgba(255, 255, 255, 0.6)" fontSize="$2" style={{ fontFamily: "monospace" }}>
      ...
      <Paragraph color="rgba(255, 255, 255, 0.5)" fontSize="$2">
        Write a GLSL fragment shader compatible with ShaderToy. Your shader must implement the mainImage function.
      </Paragraph>
    </YStack>
  );
}
